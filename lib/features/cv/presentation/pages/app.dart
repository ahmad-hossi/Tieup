...
import 'package:tieup/features/cv/presentation/pages/data.dart';
...
class ResumeScreen extends StatefulWidget {
  ...
  @override
  ResumeScreenState createState() {
    return ResumeScreenState();
  }
}

class ResumeScreenState extends State<ResumeScreen> with SingleTickerProviderStateMixin {
  int _tab = 0;
