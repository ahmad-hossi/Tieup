...
class AppliedTrainingsScreen extends StatefulWidget {
  const AppliedTrainingsScreen({Key? key}) : super(key: key);

  static const String routeName = '/AppliedTrainings';

  @override
  State<AppliedTrainingsScreen> createState() => _AppliedTrainingsScreenState();
}

class _AppliedTrainingsScreenState extends State<AppliedTrainingsScreen> {
  @override
  void initState() {
    context.read<TrainingBloc>().add(GetAppliedTrainingsEvent());
    super.initState();
  }
