...
class FavTrainingsScreen extends StatefulWidget {
  const FavTrainingsScreen({Key? key}) : super(key: key);

  static const String routeName = '/FavTrainings';

  @override
  State<FavTrainingsScreen> createState() => _FavTrainingsScreenState();
}

class _FavTrainingsScreenState extends State<FavTrainingsScreen> {
  @override
  void initState() {
    context.read<TrainingBloc>().add(GetFavTrainingsEvent());
    super.initState();
  }
