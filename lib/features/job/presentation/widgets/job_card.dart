  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        ...
        context
            .read<JobDetailBloc>()
            .add(GetJobDetailEvent(jobId: Params(id: jobInformation.id)));
        Navigator.push(
            context, MaterialPageRoute(builder: (_) => JobDetailScreen()));
      },
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            if (isAppliedCard)...{
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: Text('application date  : ${jobInformation.applicationDate}'),
              ),
              Container(
                width: double.infinity,
                color: kPrimaryColor,
                padding: const EdgeInsets.all(8.0),
                child: Text('status  : ${jobInformation.status}',style: TextStyle(color: Colors.white),),
              ),
            }
          ],
        ),
