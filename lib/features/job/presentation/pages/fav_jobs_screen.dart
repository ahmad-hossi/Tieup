...
class FavJobsScreen extends StatefulWidget {
  const FavJobsScreen({Key? key}) : super(key: key);

  static const String routeName = '/FavJobs';

  @override
  State<FavJobsScreen> createState() => _FavJobsScreenState();
}

class _FavJobsScreenState extends State<FavJobsScreen> {
  @override
  void initState() {
